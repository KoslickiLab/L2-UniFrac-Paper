...
def get_clustering_scores(predictions, test_ids, meta_dict, sample_ids):
	...
	results_dict['precision_micro'] = precision_score(true_labels, [group_label_dict[i] for i in predicted_group_test], average='micro')
	results_dict['precision_macro'] = precision_score(true_labels, [group_label_dict[i] for i in predicted_group_test], average='macro')
	results_dict['recall_micro'] = recall_score(true_labels, [group_label_dict[i] for i in predicted_group_test], average='micro')
	results_dict['recall_macro'] = recall_score(true_labels, [group_label_dict[i] for i in predicted_group_test], average='macro')
