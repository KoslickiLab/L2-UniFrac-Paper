...
def generate_rep_sample_from_metadata(meta_dict, profile_dir, outfile_name, out_format='cami'):
	'''
...
if __name__ == '__main__':
	...
	rep_sample_dict = generate_rep_sample_from_metadata(meta_dict, profile_dir, outfile_name, args.out_format)
